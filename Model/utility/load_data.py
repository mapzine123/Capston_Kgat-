...
class Data(object):
    PATH = 'D:/DEV/knowledge_graph_attention_network/Data/mykgat'
    ...
    def __init__(self, args, path):
        ...
        kg_file = self.PATH + '/kg_final.txt'
    ...
    def _generate_train_cf_batch(self):
        exist_users_list = list(self.exist_users)
        if self.batch_size <= self.n_users:
            users = rd.sample(self.exist_users, self.batch_size)
        else:
            users = [rd.choice(exist_users_list) for _ in range(self.batch_size)]
