...
def parse_args():
    ...
    parser.add_argument('--dataset', nargs='?', default='mykgat',
    ...
    parser.add_argument('--loss_type', type=str, default='default_loss_type', help='Specify the type of loss function to use.')
